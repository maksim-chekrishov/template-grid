...
_.extend(GridOptions.prototype, {
  ...
  /**
   * Array with data field(s) for grouping
   *
   * @type {Array.<string>}
   */
  group: null,
  ...
  /**
   * Builder for groupSummary row, data for header of group
   * example:
   * function(groupsRows){ return singleSummaryRow; }
   *
   * @type {Function}
   */
  groupSummaryRowBuilder: null,
